      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative flex h-[min(88vh,920px)] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-win/30 bg-[#0e1018] shadow-[0_24px_80px_rgba(0,0,0,0.75)]"
